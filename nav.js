...
const translations = {
  en: {
    ...
    pageTitleAdmin: "CRAFTSVILLA — Demonstration order administration",
    adminReturnWebsite: "Return to website",
    adminEyebrow: "LOCAL DEMONSTRATION",
    adminHeading: "Order administration demo",
    adminWarning: "This page is not securely protected. Orders are demonstration data stored only in this browser.",
    adminOrderSummaryLabel: "Order summary",
    adminSearchOrders: "Search orders",
    adminSearchPlaceholder: "Order ID, customer, or email",
    adminStatus: "Status",
    adminAllStatuses: "All statuses",
    adminSort: "Sort",
    adminSortNewest: "Newest",
    adminSortOldest: "Oldest",
    adminSortHighest: "Highest total",
    adminSortLowest: "Lowest total",
    adminCreateSample: "Create sample demo order",
    adminClearAll: "Clear all demo orders",
    adminNoOrders: "No orders found",
    adminEmptyExplanation: "Create a sample order or complete the public checkout demonstration.",
    adminOrderDetails: "Order details",
    adminCloseOrderDetails: "Close order details",
    adminStatTotalOrders: "Total orders",
    adminStatOrderValue: "Order value",
    adminStatusNew: "New",
    ...
    adminPaymentCard: "Card (simulated)",
    adminPaymentVipps: "Vipps (simulated)",
    adminPaymentPickup: "Pay on pickup (simulated)",
    adminPaymentUnknown: "Unknown",
    adminDeliveryStandard: "Standard delivery",
    adminDeliveryExpress: "Express delivery",
    adminDeliveryPickup: "Pickup",
    adminItemSingular: "{count} item",
    adminItemPlural: "{count} items",
    adminStatusForOrder: "Status for order {orderId}",
    adminViewDetails: "View details",
    adminDelete: "Delete",
    adminTotal: "Total: {total}",
    adminOrderUpdated: "Order {orderId} updated to {status}.",
    adminDeleteConfirm: "Delete demonstration order {orderId}?",
    adminOrderDeleted: "Order {orderId} deleted.",
    adminSampleCreated: "Sample demonstration order created.",
    adminClearConfirm: "Clear every locally stored demonstration order? This cannot be undone.",
    adminAllCleared: "All demonstration orders cleared.",
    adminDemoCustomer: "Demo Customer",
    adminDemoAddress: "Example Street 1",
    adminDemoCountry: "Norway",
  ...
  no: {
    ...
    navContact: "Kontakt",
    adminDemo: "Admindemo",
    languageToggleLabel: "Bytt språk",
    ...
    pageTitleAdmin: "CRAFTSVILLA — Administrasjon av demoordrer",
    adminReturnWebsite: "Tilbake til nettstedet",
    adminEyebrow: "LOKAL DEMONSTRASJON",
    adminHeading: "Demo for ordreadministrasjon",
    adminWarning: "Denne siden er ikke sikkert beskyttet. Ordrene er demonstrasjonsdata som bare lagres i denne nettleseren.",
    adminOrderSummaryLabel: "Ordresammendrag",
    adminSearchOrders: "Søk i ordrer",
    adminSearchPlaceholder: "Ordre-ID, kunde eller e-post",
    adminStatus: "Status",
    adminAllStatuses: "Alle statuser",
    adminSort: "Sorter",
    adminSortNewest: "Nyeste",
    adminSortOldest: "Eldste",
    adminSortHighest: "Høyeste totalsum",
    adminSortLowest: "Laveste totalsum",
    adminCreateSample: "Opprett eksempelordre",
    adminClearAll: "Slett alle demoordrer",
    adminNoOrders: "Ingen ordrer funnet",
    adminEmptyExplanation: "Opprett en eksempelordre eller fullfør den offentlige kassedemonstrasjonen.",
    adminOrderDetails: "Ordredetaljer",
    adminCloseOrderDetails: "Lukk ordredetaljer",
    adminStatTotalOrders: "Totalt antall ordrer",
    adminStatOrderValue: "Ordreverdi",
    adminStatusNew: "Ny",
    adminStatusProcessing: "Behandles",
    adminStatusReady: "Klar",
    adminStatusShipped: "Sendt",
    adminStatusCompleted: "Fullført",
    adminStatusCancelled: "Kansellert",
    adminPaymentCard: "Kort (simulert)",
    adminPaymentVipps: "Vipps (simulert)",
    adminPaymentPickup: "Betaling ved henting (simulert)",
    adminPaymentUnknown: "Ukjent",
    adminDeliveryStandard: "Standardlevering",
    adminDeliveryExpress: "Ekspresslevering",
    adminDeliveryPickup: "Henting",
    adminItemSingular: "{count} vare",
    adminItemPlural: "{count} varer",
    adminStatusForOrder: "Status for ordre {orderId}",
    adminViewDetails: "Vis detaljer",
    adminDelete: "Slett",
    adminTotal: "Totalt: {total}",
    adminOrderUpdated: "Ordre {orderId} ble oppdatert til {status}.",
    adminDeleteConfirm: "Vil du slette demoordre {orderId}?",
    adminOrderDeleted: "Ordre {orderId} ble slettet.",
    adminSampleCreated: "Eksempelordren ble opprettet.",
    adminClearConfirm: "Vil du slette alle lokalt lagrede demoordrer? Dette kan ikke angres.",
    adminAllCleared: "Alle demoordrer ble slettet.",
    adminDemoCustomer: "Demokunde",
    adminDemoAddress: "Eksempelgata 1",
    adminDemoCountry: "Norge",
